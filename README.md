...
**SafePath** é uma plataforma integrada que utiliza **Inteligência Artificial (IA)** e **análise de dados** para **prevenir, detectar e combater o tráfico de seres humanos** em Moçambique.  
...
* 🗺️ Mapa interativo com casos por província
* 🤖 Aprendizado contínuo com feedback de autoridades
* 🛡️ Sistema de reputação para fontes de denúncias
